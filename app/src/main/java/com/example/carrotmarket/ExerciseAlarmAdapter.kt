...
class ExerciseAlarmAdapter(val exerciseList : ArrayList<ExerciseAlarmInfo>) : RecyclerView.Adapter<ExerciseAlarmAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: ItemExerciseAlarmBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(exerciseInfo : ExerciseAlarmInfo){
